/**
 * LockedContent — premium gate for paid-only content (Resources, Videos,
 * Live Notes, Rules of the Road). Primary option: pay R150 online (Yoco).
 * Alternative: WhatsApp. Also a link to redeem an existing access code.
 */
