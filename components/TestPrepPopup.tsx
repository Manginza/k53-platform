  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-7 text-center animate-[fadeIn_0.2s_ease-out]">
        ...
        <h2 className="text-2xl font-extrabold text-gray-900 mb-1">Watch Learner&apos;s Licence Videos</h2>
        <p className="text-sm text-gray-600 mb-1">
          Study for your <strong>Learner&apos;s Licence</strong> with our video lessons.
        </p>
        <p className="text-xs text-gray-500 mb-5">
          Watch now and get ready for your test.
        </p>
