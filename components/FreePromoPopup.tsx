  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-7 text-center animate-[fadeIn_0.2s_ease-out]">
        ...
        <h2 className="text-2xl font-extrabold text-gray-900 mb-2">The course is FREE until 6am!</h2>
        <p className="text-sm text-gray-600 mb-1">
          Until <strong>6am</strong>, the entire course is unlocked — <strong>no payment needed</strong>.
        </p>
