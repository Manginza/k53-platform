...
const QUIZ_DATA = {
  ...
  12: [
    ...
    { text: 'Which of the following is an immediate-failure item that stops the test?', a: 'Checking your blind spot twice', b: 'Violating a traffic law, sign or marking, or making an uncontrolled or dangerous action', c: 'Signalling a little early', d: 'Changing gear smoothly', correct: 'B', exp: 'Immediate-failure items include violating any traffic law/sign/marking, a dangerous or uncontrolled action, an avoidable collision, mounting a kerb, or rolling forward/backward.', page: 84 },
    { text: 'During the road test you fail if you exceed how many penalty points per minute?', a: '4', b: '8', c: '20', d: '50', correct: 'B', exp: 'On the road test, exceeding 8 penalty points per minute is an immediate failure; on the yard test the limit is 50 points in total.', page: 84 },
    { text: 'On the examiner’s score sheet, a shaded box for an element means…', a: 'It is optional', b: 'You must perform that element correctly or you fail the entire test immediately', c: 'It earns bonus marks', d: 'It only applies to motorcycles', correct: 'B', exp: 'A shaded box marks an element you must do correctly; getting it wrong fails the whole test immediately.', page: 84 },
    { text: 'The more penalty points allocated to an action, the…', a: 'Less it matters', b: 'More important it is to perform that action correctly', c: 'Faster you should do it', d: 'More optional it becomes', correct: 'B', exp: 'A higher penalty-point value signals a more important action — for example, 360° observation and signalling intention each carry 5 points.', page: 84 },
  ],
  ...
  13: [
    ...
    { text: 'When using the clutch during the test, you must avoid unjustified…', a: 'Braking', b: '“Slipping”, “riding” or “coasting” of the clutch', c: 'Mirror checks', d: 'Signalling', correct: 'B', exp: 'You must avoid unjustified slipping, riding or coasting of the clutch; keep your foot off the clutch except to change gear or stop.', page: 88 },
    { text: 'When coming to a normal stop, the brakes should be applied…', a: 'After disengaging the clutch', b: 'Before disengaging the clutch, to prevent coasting', c: 'At the same instant as the clutch, always', d: 'Only after the vehicle has stopped', correct: 'B', exp: 'To prevent coasting, apply the brakes before disengaging the clutch (this is not required in stop-start traffic or when stopping on an incline).', page: 88 },
    { text: 'While the engine is running, your foot should NOT…', a: 'Rest on the clutch pedal (except in stop-start traffic)', b: 'Touch the accelerator', c: 'Be near the brake', d: 'Be flat on the floor', correct: 'A', exp: 'Resting your foot on the clutch pedal while the engine runs is penalised (“riding” the clutch), except briefly in stop-start traffic.', page: 88 },
    { text: 'Before moving off behind a stationary vehicle ahead of you, you should ensure a clear space of about…', a: '1 metre', b: '4 to 5 metres', c: '10 metres', d: '20 metres', correct: 'B', exp: 'Leave roughly 4–5 metres of clear space behind a vehicle ahead before moving off, after the required observations.', page: 86 },
    { text: 'The clutch should be fully disengaged…', a: 'As soon as you start braking', b: 'Just before the vehicle comes to a complete stop, without stalling or labouring the engine', c: 'Only after the vehicle has stopped', d: 'At the top of every gear', correct: 'B', exp: 'Disengage the clutch completely just before the vehicle stops so the engine does not stall or labour.', page: 88 },
  ],
  ...
  14: [
    ...
    { text: 'In the test, the absolute-minimum following distance (“clear space”) for a light motor vehicle is…', a: '2 seconds', b: '4 seconds', c: '6 seconds', d: 'Half a second', correct: 'A', exp: 'The test’s absolute minimum is 2 seconds for a light motor vehicle (3 seconds for heavy/motorcycle); the recommended safe minimum is 3 seconds (6 for heavy).', page: 92 },
    { text: 'The K53 action “Accelerate” means to…', a: 'Speed up as fast as possible', b: 'Increase speed safely, with due regard to the traffic, road, weather, visibility and the speed limit', c: 'Press the accelerator fully', d: 'Accelerate only in first gear', correct: 'B', exp: 'Accelerate means increasing speed safely and with consideration for the conditions and any applicable speed limit.', page: 92 },
    { text: 'The K53 “Group 1” actions (used when a signal is required) are…', a: 'Brake, steer, accelerate', b: 'Observe 360°, check the blind spots, and signal your intention', c: 'Clutch, gear, accelerator', d: 'Stop, look, listen', correct: 'B', exp: 'Group 1 actions are Observe 360°, check the blind spots, and signal intention — performed when a signal is required.', page: 92 },
    { text: 'On a motorcycle, “counter-steer” means to…', a: 'Brake with the front wheel only', b: 'Turn the handlebars briefly in the opposite direction to the way you have just turned', c: 'Lean backwards', d: 'Change down a gear', correct: 'B', exp: 'Counter-steering means turning the steering/handlebars hard in the opposite direction to the one just turned, used to control the machine.', page: 92 },
  ],
  ...
  15: [
    ...
    { text: 'During the yard-test manoeuvres, the push-and-pull method of steering is…', a: 'Compulsory', b: 'Not required', c: 'Only used in reverse', d: 'Penalised', correct: 'B', exp: 'The push-and-pull steering method is not required during the yard-test manoeuvres (it is expected on the road test).', page: 98 },
    { text: 'If you bump an obstacle or mount a kerb during a yard manoeuvre, you will…', a: 'Lose one point', b: 'Fail, and the test will be discontinued', c: 'Get a warning', d: 'Be allowed a third attempt', correct: 'B', exp: 'Bumping an obstacle or mounting a kerb during any manoeuvre is an immediate failure and the test is discontinued.', page: 98 },
    { text: 'Do the rules of the road and road signs still apply during the yard test?', a: 'No, the yard is exempt', b: 'Yes — all rules of the road, signs, signals and markings must be obeyed', c: 'Only the speed limit applies', d: 'Only on the road test', correct: 'B', exp: 'All rules of the road, traffic signs, signals and road-surface markings must be obeyed during the yard test as well.', page: 98 },
    { text: 'In the starting procedure, before starting the engine you must first ensure that…', a: 'The radio is off', b: 'The parking brake is applied and the gear lever is in neutral (P or N for automatics)', c: 'The windows are open', d: 'The headlights are on', correct: 'B', exp: 'The starting procedure begins with the parking brake applied and the gear lever in neutral (or P/N), before turning the key.', page: 98 },
    { text: 'When reversing during the turn-in-the-road (three-point turn), just before you stop you should…', a: 'Accelerate hard', b: 'Counter-steer in the opposite direction', c: 'Select a forward gear', d: 'Release the steering wheel', correct: 'B', exp: 'While reversing you steer sharply one way, then counter-steer the opposite way just before stopping, ready for the next movement.', page: 104 },
    { text: 'At a Yield sign, the correct observation on approach is to…', a: 'Look only straight ahead', b: 'Look right, then left, then right again (and ahead) for traffic and pedestrians', c: 'Look left only', d: 'Close your eyes and listen', correct: 'B', exp: 'On approaching a Yield sign you look right, then left, then right again and ahead for approaching traffic, cross-traffic and pedestrians, giving way at the broken yield line if necessary.', page: 120 },
  ],
}
