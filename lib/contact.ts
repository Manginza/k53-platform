...
export const WHATSAPP_MESSAGE = "I'm interested in buying the course for R139 (special, down from R150)."
...
export const ACCESS_PRICE = 'R139'
export const ACCESS_PRICE_CENTS = 13900           // R139.00 in ZAR cents (Yoco)
export const ACCESS_PRICE_ORIGINAL = 'R150'       // shown struck-through
export const ACCESS_DISCOUNT_LABEL = 'Save R11'   // (R150 − R139)
